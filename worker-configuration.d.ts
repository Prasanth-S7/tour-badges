/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 27f208fb09efa07ae12a51da89f6c003)
...
declare namespace Cloudflare {
	interface Env {
        ...
        BADGR_CLIENT_ID: string;
        BADGR_CLIENT_SECRET: string;
        BADGR_REDIRECT_URI: string;
